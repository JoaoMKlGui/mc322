...
public class ClientePJ extends Cliente {
    ...
    public String toString() {
        return super.toString() + "CNPJ: " + this.cnpj + "\n" + "Data de Nascimento: " + String.valueOf(this.dataFundacao.get(Calendar.DAY_OF_MONTH)) + "/" + String.valueOf(this.dataFundacao.get(Calendar.MONTH) + 1) + "/" + String.valueOf(this.dataFundacao.get(Calendar.YEAR)) + "\n";
    }
